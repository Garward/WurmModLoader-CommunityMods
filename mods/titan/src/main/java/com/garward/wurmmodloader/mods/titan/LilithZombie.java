...
public class LilithZombie implements ModCreature, CreatureTypes {
    ...
    public CreatureTemplateBuilder createCreateTemplateBuilder() {
        ...
        CreatureTemplateBuilder builder = new CreatureTemplateBuilder(
                "mod.creature.lilith.zombie", "Servant of Lilith", "A mindless minion of Lilith.",
                "model.creature.humanoid.human.player.zombie",
                types, BodyTemplate.TYPE_HUMAN, (short) 30, (byte) 0,
                (short) 85, (short) 50, (short) 85,
                "sound.death.zombie", "sound.death.zombie",
                "sound.combat.hit.zombie", "sound.combat.hit.zombie",
